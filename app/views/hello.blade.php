...
<!-- Must link CSS files using the laravel asset() methods -->
<link rel="stylesheet" href="{{URL::asset('css/main.css')}}">
<!-- double braces from blade executes and echoes out php statements -->
</head>
<body>
	<div class="welcome">
		...
		<!-- below is a laravel control statement format.. uses conditionals like if/else and new "unless" -->
		@if($theWeather == 'sunny')
	...
	<!-- Blade template for each loop here  -->
		<ul class="bladeloops">
